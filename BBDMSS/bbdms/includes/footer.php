          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood </span>Donor Management System 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>We welcome every new donor who joins us to save and improve lives.
Make a life changing Impact: Donate blood,save lives.Together we can heal communities."Be a hero, donate blood," "Every blood donor is a lifesaver," and "Donate blood, share life"
</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1"> BBDMS Mini Project MITM</p>
           <p>Developed by Koushik M & Manoj M
          </p>
        </div>
      </div>
    </div>
